...
public class ProfileActivity extends AppCompatActivity {
    ...
    private String id,name,email,phone,designaton,gender,address;
    ...
    private void getValue() {
        ...
        stringRequest = new StringRequest(Request.Method.GET, "http://i-access.ingtechbd.com/api/users/view/"+1,
