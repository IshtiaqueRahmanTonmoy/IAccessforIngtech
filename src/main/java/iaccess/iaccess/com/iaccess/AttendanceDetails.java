...
public class AttendanceDetails extends AppCompatActivity {
    ...
    String names,designations,year,mth,d,v,idval,roleval,access_token,Authorization,id,ids,name,date,intime,outtime,in_location,out_location,working_hour,overtime,remarks,timestamp,month,day,hour,timestampsout,hourout,fromto;
    @Override
