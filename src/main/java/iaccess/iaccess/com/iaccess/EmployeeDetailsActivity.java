...
public class EmployeeDetailsActivity extends AppCompatActivity {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch(id) {
                            ...
                            case R.id.delete:
                                ...
                                AlertDialog.Builder builder1 = new AlertDialog.Builder(EmployeeDetailsActivity.this);
                                builder1.setMessage("Do you want to delete this account.");
    ...
    private void delete() {
        ...
        stringRequest = new StringRequest(Request.Method.DELETE, "http://i-attendance.ingtechbd.com/api/users/delete/"+idval,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {

                            progressDialog.dismiss();
                            Toast.makeText(EmployeeDetailsActivity.this, "Account deleted", Toast.LENGTH_SHORT).show();
